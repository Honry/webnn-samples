...
export class DeepLabV3MNV2Nchw {
  constructor() {
    ...
    this.inputOptions = {
      ...
      inputDimensions: [1, 3, 321, 321],
    };
    this.outputDimensions = [1, 21, 321, 321];
  }
  ...
  async load(devicePreference) {
    ...
    const resample1 = this.builder_.resample(
        conv6, {sizes: [1, 21, 41, 41], mode: 'linear'});
    return this.builder_.resample(
        resample1, {sizes: [1, 21, 321, 321], mode: 'linear'});
  }
